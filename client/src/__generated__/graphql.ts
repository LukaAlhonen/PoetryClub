...
export type PoemCardFragmentFragment = { __typename?: 'Poem', id: string, title: string, text: string, datePublished: any, author: { __typename?: 'User', username: string } } & { ' $fragmentName'?: 'PoemCardFragmentFragment' };
